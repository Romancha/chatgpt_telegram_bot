...
class ChatGPT:
    def __init__(self, model="gpt-4.1-mini"):
        assert model in {"gpt-4.1", "gpt-4.1-mini", "gpt-4.1-nano", "gpt-4o"}, f"Unknown model: {model}"
        self.model = model
    ...
    async def send_message(self, message, dialog_messages=[], chat_mode="assistant"):
        ...
        while answer is None:
            try:
                if self.model in {"gpt-4.1", "gpt-4.1-mini", "gpt-4.1-nano", "gpt-4o"}:
    ...
    def _count_tokens_from_messages(self, messages, answer, model="gpt-4.1-mini"):
        # Map new models to compatible tokenizers
